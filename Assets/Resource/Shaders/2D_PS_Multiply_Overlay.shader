Shader "Custom/2D_PS_Multiply_Overlay"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // URP 2D Renderer 不生成 _CameraOpaqueTexture，采样其官方等效的相机排序层纹理
            ...
            Varyings vert(Attributes input)
            {
                ...
                // 屏幕UV，用于采样底层画面
                output.screenUV = ComputeScreenPos(output.posHCS);
                return output;
            }
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half4 baseTex = SAMPLE_TEXTURE2D(_CameraSortingLayerTexture, sampler_CameraSortingLayerTexture, screenUV);
                half3 resultRGB;
